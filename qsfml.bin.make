...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/qsfml.bin
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/qsfml.bin
...
OBJECTS := \
	$(OBJDIR)/qsfmlcancas.o \
	$(OBJDIR)/mycanvas.o \
	$(OBJDIR)/Main.o \
	$(OBJDIR)/qsfmlcanvas.o \
	$(OBJDIR)/moc_qsfmlcancas.o \
...
$(OBJDIR)/qsfmlcancas.o: src/QTSFML/qsfmlcancas.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/mycanvas.o: src/QTSFML/mycanvas.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Main.o: src/QTSFML/Main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/qsfmlcanvas.o: src/QTSFML/qsfmlcanvas.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/moc_qsfmlcancas.o: $(MOCDIR)/moc_qsfmlcancas.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
...
$(MOCDIR)/moc_qsfmlcancas.cpp: src/QTSFML/qsfmlcancas.h
	@echo moc qsfmlcancas.h
	$(SILENT) $(QTMOC) $(MOCFLAGS) -nw -o "$@" "$<"


prebuild: $(QT_DIRS) $(MOCDIR)/moc_qsfmlcancas.cpp
